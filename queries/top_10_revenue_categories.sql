...
-- Top 10 categorías por revenue y # de órdenes (únicas)
-- Traducción a inglés cuando exista; solo delivered.
-- 10 categorías con MAYOR revenue (SUM(oi.price)), SOLO órdenes entregadas, en inglés.
-- 10 categorías con MAYOR revenue (SUM(price + freight_value)), SOLO entregadas, en inglés.
SELECT
